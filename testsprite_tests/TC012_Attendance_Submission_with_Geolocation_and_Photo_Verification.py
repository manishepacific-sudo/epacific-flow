...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Attendance submission successful and pending review').first).to_be_visible(timeout=30000)
        except AssertionError:
            raise AssertionError('Test case failed: Attendance submission was not recorded successfully or not listed as pending review as required by the test plan.')
