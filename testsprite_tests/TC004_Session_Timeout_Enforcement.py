...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password, then click Sign In button to log in as any user role
        ...
        try:
            ...
            raise AssertionError('Test case failed: The system did not log out the user automatically after the configured session timeout period as expected.')
