...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: The system did not reject the upload of unsupported or corrupted files with an appropriate validation error message as expected.')
