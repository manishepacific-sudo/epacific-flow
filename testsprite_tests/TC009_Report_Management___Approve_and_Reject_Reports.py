...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Report Approval Successful').first).to_be_visible(timeout=30000)
        except AssertionError:
            raise AssertionError('Test case failed: Admins and managers could not review, approve, or reject uploaded reports, or changes in status were not reflected properly as per the test plan.')
