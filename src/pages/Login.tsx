    ...
    try {
      ...
      if (data.user) {
        ...
        if (profileError) {
          ...
          // Try to use user metadata as fallback
          const role = data.user.user_metadata?.role || 'user';
          const name = data.user.user_metadata?.full_name || data.user.email;
          
          toast({
            title: "Welcome back!",
            description: `Hello ${name}, you have been successfully logged in.`,
          });
        ...
        if (profile) {
          ...
          toast({
            title: "Welcome back!",
            description: `Hello ${fullName}, you have been successfully logged in.`,
          });
