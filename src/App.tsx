...
const UserPaymentDetailPage = lazy(() => import("./pages/UserPaymentDetailPage"));
...
const GuardedUserProfile = withRoleGuard(UserProfilePage, ['admin', 'manager']);
        ...
        <ThemeProvider>
          <TooltipProvider>
            ...
            <BrowserRouter>
              ...
              <Route path="/payment-detail/:id" element={
                <ProtectedRoute>
                  <PaymentDetailPage />
                </ProtectedRoute>
              } />
              <Route path="/payment/user/:id" element={
                <ProtectedRoute>
