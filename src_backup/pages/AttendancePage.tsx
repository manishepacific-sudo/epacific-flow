      ...
      <div className="max-w-2xl mx-auto space-y-6 sm:space-y-8">
        ...
        >
          <GlassCard className="p-4 sm:p-6">
            ...
            {photo ? (
              <div className="border-2 border-dashed border-success bg-success/5 rounded-xl p-6 text-center">
                <Check className="w-12 h-12 mx-auto mb-3 text-success" />
                <img 
                  src={URL.createObjectURL(photo)} 
                  alt="Attendance preview" 
                  className="w-32 h-32 mx-auto rounded-lg object-cover border-2 border-success mb-3"
                />
        ...
        <Dialog open={showPhotoOptions} onOpenChange={setShowPhotoOptions}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              <DialogTitle>Add Attendance Photo</DialogTitle>
              <DialogDescription>
            ...
            <div className="grid gap-3 py-4">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">Use camera to capture selfie</div>
                </div>
              </Button>
              ...
              >
                <Upload className="h-6 w-6 mr-3 text-secondary" />
                <div>
